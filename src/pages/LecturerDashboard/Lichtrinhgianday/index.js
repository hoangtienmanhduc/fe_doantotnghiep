...
import styles from '~/pages/LecturerDashboard/Lichtrinhgianday/Lichtrinhgianday.module.scss';
...
function Lichtrinhgiangday() {
    ...
    return (
        <div className={cx('wrapper')}>
            ...
            >
                <h2>LỊCH TRÌNH GIẢNG DẠY</h2>
            </div>
            <p style={{ textAlign: 'center' }}>
                ______________________________________________________________________________________________________________________________________________________________________________________________________
            </p>
            <div style={{ display: 'flex', marginTop: '15px', marginLeft: '450px' }}>
            ...
            >
                <table
                    ...
                    className={cx('table table-bordered table-striped')}
                    width={1200}
                >
                    <thead>
