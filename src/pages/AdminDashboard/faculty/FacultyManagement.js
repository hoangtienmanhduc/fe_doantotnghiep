...
const FacultyManagement = () => {
    const { data, refetch } = useQuery([QueryKey, getUserId()], () => getPageFacultyInfo(getUserId()), {
        enabled: !!getUserId(),
    });
    ...
    const header = (
        <div className="flex flex-wrap align-items-center justify-content-between gap-2 p-3">
            <h2 className="text-900 font-bold">Faculty Management</h2>
            <div className="flex align-items-center ">
                ...
                <Button
                    ...
                    rounded
                    raised
                    onClick={() => facultyRef.current.showForm()}
                />
            </div>
        </div>
    );
